...
public sealed class Dictionary
{
    ...
    public Dictionary(IWebHostEnvironment env)
    {
        var dataPath = Path.Combine(env.ContentRootPath, "Data");
        var sourcePath = Path.Combine(dataPath, "words.txt");
        var filteredPath = Path.Combine(dataPath, "words.filtered.txt");
        ...
        EnsureFilteredWords(sourcePath, filteredPath);
        Load(filteredPath);
